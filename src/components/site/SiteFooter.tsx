      ...
      <div className="shell flex flex-col gap-10 py-14 md:flex-row md:items-end md:justify-between">
        <div className="flex max-w-md flex-col gap-3">
          ...
          <p className="type-body text-bone-3">
            An unhurried field guide to the concepts behind modern AI. Made by{" "}
            <a
        ...
        <div className="flex flex-col gap-2 type-mono-sm text-right">
          <span>Edition 01 · April 2026</span>
