...
flowchart TD
  ...
  D --> E[Phase 3: article-design]
  E --> F[Phase 4: Implement + lint/build/test]
  F --> G[Phase 5: article-humanize]
  G --> H[Phase 6: article-review]
  H --> I{Critical issues?}
  I -->|Yes| F
  I -->|No| J[Phase 7: Push + PR to develop]
